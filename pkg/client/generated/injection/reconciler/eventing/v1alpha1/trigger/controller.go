...
import (
	...
	trigger "github.com/triggermesh/triggermesh-core/pkg/client/generated/injection/informers/eventing/v1alpha1/trigger"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "triggers.eventing.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "eventing.triggermesh.io.Trigger"),
	)
