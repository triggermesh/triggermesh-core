...
import (
	...
	internalclientsetscheme "github.com/triggermesh/triggermesh-core/pkg/client/generated/clientset/internalclientset/scheme"
...
const (
	defaultControllerAgentName = "redisbroker-controller"
	defaultFinalizerName       = "redisbrokers.eventing.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	redisbrokerInformer := redisbroker.Get(ctx)

	lister := redisbrokerInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "eventing.triggermesh.io.RedisBroker"),
	)
