...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.RedisBroker, desired *v1alpha1.RedisBroker) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.RedisBroker) (*v1alpha1.RedisBroker, error) {

	getter := r.Lister.RedisBrokers(resource.Namespace)
