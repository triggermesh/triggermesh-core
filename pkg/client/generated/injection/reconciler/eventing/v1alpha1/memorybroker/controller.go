...
const (
	defaultControllerAgentName = "memorybroker-controller"
	defaultFinalizerName       = "memorybrokers.eventing.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	memorybrokerInformer := memorybroker.Get(ctx)

	lister := memorybrokerInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "eventing.triggermesh.io.MemoryBroker"),
	)
