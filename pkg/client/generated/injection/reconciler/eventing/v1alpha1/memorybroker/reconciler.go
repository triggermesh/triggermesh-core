...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.MemoryBroker, desired *v1alpha1.MemoryBroker) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.MemoryBroker) (*v1alpha1.MemoryBroker, error) {

	getter := r.Lister.MemoryBrokers(resource.Namespace)
