...
func Get(ctx context.Context) v1alpha1.RedisReplayInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/triggermesh/triggermesh-core/pkg/client/generated/informers/externalversions/eventing/v1alpha1.RedisReplayInformer from context.")
	}
