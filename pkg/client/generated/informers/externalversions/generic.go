...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("redisreplays"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Eventing().V1alpha1().RedisReplays().Informer()}, nil
